    ...
    public partial class MainWindow : Window
    {
        ...
        public static PropertyMetadata Meta
        {
            get
            {
                ...
                {
                    if (!uint.TryParse(ConfigurationManager.AppSettings.Get("trialDays"), out uint trial))
                        trial = 21;
        ...
        private void thisView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (App.ResourceAssembly == null)
            {
                App.ResourceAssembly = Assembly.GetAssembly(typeof(App));
            }
